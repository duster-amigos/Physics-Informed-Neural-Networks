...
class PINNs(models.Model):
    """
    Physics-Informed Neural Network (PINN) for the ZPG boundary layer problem.
    Approximates the solution to the system:
        \[
        f_1 = U U_x + V U_y - \nu (U_{xx} + U_{yy}) + uv_y
        \]
        \[
    ...
    def __init__(self, model: Any, optimizer: Any, epochs: int, **kwargs):
        ...
        self.nu = 1 / 450
        logger.info("PINNs model for ZPG initialized.")
